...
class RentalCarViewWithDriver extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<CarWithDriverController>(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                                  ...
                                                  children: [
                                                    ...
                                                    FittedBox(
                                                      child: ResponsiveText(
                                                        scaleFactor: .04,
                                                        text:
                                                            " ${controller.carswithdriver[index]['car']['type']}",
                                                        color: AppColors.black,
                                                        fontWeight:
                                                            FontWeight.bold,
                                                      ),
                                                  ...
                                                  children: [
                                                    ...
                                                    FittedBox(
                                                      child: ResponsiveText(
                                                        scaleFactor: .04,
                                                        text:
                                                            'تاريخ النشر : ${controller.carswithdriver[index]['publishDate']}',
                                                        color: AppColors.black,
                                                        fontWeight:
                                                            FontWeight.bold,
                                                      ),
                                        ...
                                        InkWell(
                                          onTap: () =>
                                              navigateTo(RentalCarOwnerView(
                                            ownerId:
                                                controller.carswithdriver[index]
                                                    ['userId'],
                                            price: controller
                                                .carswithdriver[index]['price'],
                                            phone: controller
                                                .carswithdriver[index]['phone'],
                                            image:
                                                controller.carswithdriver[index]
                                                    ['car']['images'][0],
                                            cartype:
